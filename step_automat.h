...
private:
    /*!
     \brief конструктор копирования - запрещаем вызов извне.
    */
    Func(const Func&);

    /*!
     \brief оператор присваивания - запрещаем вызов извне.
    */
...
private:
    ...
    /*!
      \brief функтор для кондвара
      \return булево значение, указывающее на то, можно ли производить выполнение состояния
      \warning в 11 стандарте можно использовать лямбду
     */
    class canExec // функтор для вариадика (в 11 плюсах можно лямбду)
	{
	public:
